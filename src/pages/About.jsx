...
export default function About() {
  return (
    <section id="about" className="min-h-screen text-white flex flex-col justify-center items-center px-10 py-20">
      <h2 className="text-4xl font-bold mb-6 dark:text-white">À propos</h2>
      {/* Bloc présentation */}
     ...
     <p className="mt-8  text-gray-700 flex flex-wrap justify-center gap-6">
      ...
      <div data-aos="fade-up" id="formations"className="text-gray-700 mt-12 max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
        {/* Formations */}
                <div className="dark:bg-white/80 shadow-lg rounded-2xl p-6 hover:shadow-2xl hover:-translate-y-1 transition duration-300 flex flex-col justify-between min-h-[350px]">
           <div className=" bg-gradient-to-br from-white to-blue-100 text-xs px-3 py-1 rounded-full font-medium shadow-sm transition">
        ...
        {/* Certifications */}
        <div className="dark:bg-white/80 bg-gradient-to-br from-white to-blue-100 shadow-lg rounded-2xl p-6 hover:shadow-2xl hover:-translate-y-1 transition duration-300">
